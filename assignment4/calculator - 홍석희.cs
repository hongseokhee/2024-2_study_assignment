...
namespace calculator
{
    ...
    public class Calculator
    {
        public double Calculate(double num1, string op, double num2){
            ...
            else if (op == "**") return System.Math.Pow(num1, (int)num2);
            else if (op == "%") return (int)num1 % (int)num2;
            else if (op == "G") {
                int smaller = (int)num1>(int)num2? (int)num2 : (int)num1;
                int bigger = (int)num1<(int)num2? (int)num2 : (int)num1;
                int G = 0;
